...
import de.ait.platform.recipes.exception.ArticleNotFound;
...
@Autowired
    ...
    public CommentsResponseDto save(CommentsRequestDto dto) {
        ...
        Recipe recipe = articleRepository.findById(dto.getArticle_id())
        ...
        return new CommentsResponseDto(savedComment.getId(),
                ...
                .getUser().getId(), newComment.getRecipe().getId());
    }
