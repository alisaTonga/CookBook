package de.ait.platform.categories.controller;

import com.fasterxml.jackson.databind.ObjectMapper;
import de.ait.platform.recipes.entity.Recipe;
import de.ait.platform.recipes.service.ArticleService;
...
import de.ait.platform.categories.service.CategoryService;
...
class CategoryControllerTest {
    ...
    public void setup() {
        ...
        Recipe recipe = Recipe.builder().id(1L).title("Test Article").content("Test Content").build();
    }
    ...
    void CategoryController_addArticleToCategory() throws Exception {
        Long articleId = 1L;
        Long categoryId = 1L;
        given(categoryService.addArticleToCategory(articleId,categoryId)).willReturn(categoryResponse.getRecipes());
